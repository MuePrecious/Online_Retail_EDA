...
## Project Overview
---
This dataset contains all purchases made for an online retail company based in the UK, it is dirty and is to be cleaned for Exploratory Data Analysis and visualization, in order to draw meaningful business insights and give recommended data-driven decisions.
